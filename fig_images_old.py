# This version of the script contains logic to automatically choose a well/site/coordinate for the
# figure. The final version of the script takes all its inputs from a manually curated csv file that
# was initialized with this script's generated well/site/coordinates.
...
## Original best-M1-based marker selection, before clustering approach was settled.
# markers = (
#     m1m
#     .stack()
...
markers = dfcg.set_index('cell_id')['marker']
...
metas = []
for (plate_row_line, marker) in tqdm.tqdm(markers.items(), total=len(markers)):
